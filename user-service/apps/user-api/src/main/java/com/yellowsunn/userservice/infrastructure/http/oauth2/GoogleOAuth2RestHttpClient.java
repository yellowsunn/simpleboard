...
import com.yellowsunn.userservice.infrastructure.http.response.GoogleOAuth2UserInfoResponse;
import java.net.URI;
...
public class GoogleOAuth2RestHttpClient implements OAuth2UserInfoHttpClient {
    ...
    public OAuth2UserInfo findUserInfo(String token, OAuth2Request oAuth2Request) {
        ...
        var responseDto = restTemplate.getForObject(uri, GoogleOAuth2UserInfoResponse.class);
